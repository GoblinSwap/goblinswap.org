...
const cn = {
  ...
  "swap":{
    "transfer13": "輸入的數量必須大於10",
    "transfer14": "輸入的數量不能大於可用余額",
    "swap1": "連接錢包",
    "swap2": "簡體中文",
    "swap3": "英文",
    "swap4": "白皮書",
    ...
    "swap12": "請輸入密碼",
    "swap13": "已提交成功",
    "swap14": "在NULSCAN上進行查看",
    "swap15": "備份私鑰",
    "swap16": "復制",
    "swap17": "請保護好妳的私鑰，如若遺失，錢包將無法幫妳找回",
    "swap18": "完成備份",
    "swap19": "創建NULS錢包賬戶",
    "swap20": "請創建壹個NULS錢包以連接到該DAPP",
    "swap21": "密碼",
    "swap22": "請輸入密碼",
    "swap23": "確認密碼",
    "swap24": "請再次輸入密碼",
    ...
    "swap31": "挖礦收益",
    "swap32": "導入NULS錢包私鑰",
    "swap33": "此DAPP需要訪問您的錢包，請輸入您的賬號私鑰已繼續。",
    "swap34": "私鑰",
    "swap35": "輸入私鑰",
    "swap36": "導入錢包",
    "swap37": "鎖定",
    ...
    "swap42": "挖礦收益",
    "swap43": "待開啟",
    "swap44": "可收獲時間預計：10月10日",
    "swap45": "醒醒該起床去阿拉希盆地挖礦了",
    "swap46": "鎖倉NULS參與挖礦 賺取GOBLIN",
    "swap47": "總鎖倉",
    "swap48": "鎖倉NULS 賺取GOBLIN",
    "swap49": "挖礦",
    "swap50": "NULS池總鎖倉",
    "swap51": "智能合約",
    "swap52": "9月29日 12:00 (UTC+8) 敬請期待！",
    "swap53": "礦工正在等待",
    "swap54": "退出",
    "swap55": "解鎖&收獲",
    "swap56": "私鑰導入失敗，請重啟再試壹次 ",
    "swap57": "快捷連接",
    "swap58": "NULS連接",
    "swap59": "提示",
    "swap60": "由於升級挖礦合約，請先解鎖當前您已鎖定的",
    "swap61": "NULS，完成解鎖操作後的24小時內社區將會把已挖取的GOBLIN轉賬到您的錢包中",
    "swap62": "解鎖",
  },
